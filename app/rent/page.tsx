    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-8 flex items-center justify-between">
          <h1 className="text-3xl font-bold text-foreground md:text-4xl">{t("rent.title")}</h1>
          <Button
            variant="outline"
        ...
        {rentProperties.length === 0 && (
          <div className="py-20 text-center">
            <p className="text-lg text-muted-foreground">No rental properties found matching your criteria.</p>
