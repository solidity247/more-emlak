        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {hotOffers.map((offer, i) => (
            <Link href="/catalog" key={offer.id}>
              <Card className="group cursor-pointer overflow-hidden border-border bg-card transition-all hover:-translate-y-1 hover:shadow-xl"
              ...
              >
                ...
                <CardContent className="p-4">
                  <h3 className="mb-1 font-semibold text-card-foreground">{offer.title}</h3>
                  <p className="mb-3 text-sm text-muted-foreground">{offer.district}</p>
